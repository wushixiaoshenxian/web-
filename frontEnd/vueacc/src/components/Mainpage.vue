<template>
    <div class="mainpage">
        <div class="navigation">
            ...
            <el-menu mode="horizontal" :default-active="data.active1" background-color="#e7f2ef">
                <el-menu-item index="1" @click="data.active1=1;">首页</el-menu-item>
                <el-menu-item index="2" @click="data.active1=2;">设置回复</el-menu-item>
            </el-menu>
            </div>
            <div class="navigation-right">
            <el-avatar :size="size" :src="data.pictureuurl" class="userpicture"></el-avatar>
        ...
        <div class="friendlist-list">
            ...
            <el-menu  :default-active="data.active2" background-color="#e7f2ef">
                 <el-menu-item v-for="myfriend in data.friend" 
                 :key="myfriend.id" 
                 class="friend"
                 @click="getmessage(myfriend)"
                 >{{myfriend}}</el-menu-item>
                 <el-menu-item 
                 class="addfriend"
                 @click="toaddfriend"
                 >添加新朋友</el-menu-item>
        ...
        <div v-if="data.write===true" class="write-message">
            ...
            <el-form class="writemessage-form" label-width="150px">
                ...
                <el-form-item label="想说的话：">
                    <el-input type="textarea" v-model="data.writemessage.message"></el-input>
                </el-form-item>
                <el-form-item label="权值：">
                    <el-input v-model="data.writemessage.value" style="width:100px"></el-input>
                </el-form-item>
            </el-form>
            <el-button
            size="large"
        ...
        <div v-if="data.active1===1&&data.addfriend===false&&data.write===false" class="show-message">
            <header><h1 style="background-color:rgba(132, 201, 219)">人情记事本</h1></header>
            <div class="middle">
            ...
            <footer><h1 style="background-color:rgba(132, 201, 219)">合计：<el-button class="btn-write" @click="towrite">记事</el-button></h1></footer>
        </div>
        <div v-if="data.active1===2" class="setcallback"> 
            ...
            <el-form class="setback-form" label-width="100px">
                <el-form-item label="邮件：">
                    <el-input v-model="data.setback.email" style="width:300px"></el-input>
                </el-form-item>
                <el-form-item label="想说的话：">
...
export default {
    setup() {
        const data=reactive({
            active1:1,
            active2:1,
            pictureuurl:"https://cube.elemecdn.com/9/c2/f0ee8a3c7c9638a54940382568c9dpng.png",
            username:"张三",
    ...
    methods:{
        ...
        addfriend(){
            axios.post("",{
                ...
                if(res.data.code===200)
                {
                    this.friend.push(this.data.newfriendname);
                    this.data.addfriend=false;
                }
            }).catch(err=>{
                console.log(err);
...
.show-message,.add-friend,.write-message,.setcallback{
    position: absolute;
    left:250px;
    top:60px;
    width:1300px;
...
.writemessage-form,.setback-form{
    margin:30px 50px;
}
</style>